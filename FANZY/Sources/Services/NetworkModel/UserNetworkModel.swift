...
enum UserNetworkModel{
  case getTransfer
  case getRevenue(offset: String)
  case getWatchingRevenue(offset: String)
  case getUsersChannel(userId: String)
}

extension UserNetworkModel: TargetType {
  ...
  var path: String {
    ...
    case let .getUsersChannel(userId):
  ...
  var method: Moya.Method {
    switch self {
    case .getRevenue, .getTransfer, .getWatchingRevenue, .getUsersChannel:
      return .get
    }
  }
  ...
  var task: Task {
    switch self {
    case .getRevenue, .getTransfer, .getWatchingRevenue, .getUsersChannel: // Send no parameters
      return .requestPlain
    }
  }
