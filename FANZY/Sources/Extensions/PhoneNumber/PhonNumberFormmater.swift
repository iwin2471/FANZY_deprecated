//
//  PhonNumberFormmater.swift
//  FANZY
//
//  Created by 김연준 on 17/06/2019.
...
class PhoneFormattedTextField: UITextField {
  private let formatProxy: FormattedTextFieldDelegate
  private let formatter: PhoneFormatter
  var padding = UIEdgeInsets(top: 10, left: 30, bottom: 10, right: 40)
